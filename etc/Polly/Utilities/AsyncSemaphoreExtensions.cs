...
{
    /// <summary>
    /// Contains extension methods for CuteAnt.AsyncEx.AsyncSemaphore
    /// </summary>
    public static class AsyncSemaphoreExtensions
    {
        ...
        /// <param name="asyncSemaphore">The <see cref="T:CuteAnt.AsyncEx.AsyncSemaphore"/> instance.</param>
        ...
        {
            if (timeSpan != TimeSpan.Zero) { throw new NotSupportedException("This extension method to CuteAnt.AsyncEx.AsyncSemaphore intends only to imitate the behaviour of System.Threading.SemaphoreSlim.Wait(TimeSpan..., ) when the TimeSpan supplied is TimeSpan.Zero."); }
        ...
        {
            if (timeSpan != TimeSpan.Zero) { throw new NotSupportedException("This extension method to CuteAnt.AsyncEx.AsyncSemaphore intends only to imitate the behaviour of System.Threading.SemaphoreSlim.WaitAsync(TimeSpan..., ) when the TimeSpan supplied is TimeSpan.Zero."); }
        ...
        {
            // None to do.  The original implementation of CuteAnt.AsyncEx.AsyncSemaphore is not IDisposable.
        }
    }
}
