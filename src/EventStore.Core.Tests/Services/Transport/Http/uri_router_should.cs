...
namespace EventStore.Core.Tests.Services.Transport.Http
{
    ...
    public abstract class uri_router_should
    {
        ...
        public void SetUp()
        {
            ...
            _router.RegisterAction(new ControllerAction("/", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);
            _router.RegisterAction(new ControllerAction("/{placeholder}", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);
            _router.RegisterAction(new ControllerAction("/halt", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);
            _router.RegisterAction(new ControllerAction("/streams/{stream}/{event}/backward/{count}?embed={embed}", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);
            _router.RegisterAction(new ControllerAction("/projection/{name}?deleteStateStream={deleteStateStream}&deleteCheckpointStream={deleteCheckpointStream}", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);
            _router.RegisterAction(new ControllerAction("/s/stats/{*statPath}", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);
            _router.RegisterAction(new ControllerAction("/streams/$all/", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);
            _router.RegisterAction(new ControllerAction("/streams/$$all", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);
            _router.RegisterAction(new ControllerAction("/streams/$mono?param={param}", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);

            _router.RegisterAction(new ControllerAction("/streams/test", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);
            _router.RegisterAction(new ControllerAction("/streams/test", HttpMethod.Post, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);

            _router.RegisterAction(new ControllerAction("/t/{placeholder1}/{placholder2}/{placeholder3}", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);
            _router.RegisterAction(new ControllerAction("/t/{placeholder1}/{placholder2}/something", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);
            _router.RegisterAction(new ControllerAction("/t/{placeholder1}/something/{placeholder3}", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);
            _router.RegisterAction(new ControllerAction("/t/{placeholder1}/something/something", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);
            _router.RegisterAction(new ControllerAction("/t/something/{placholder2}/{placeholder3}", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);
            _router.RegisterAction(new ControllerAction("/t/something/{placholder2}/something", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);
            _router.RegisterAction(new ControllerAction("/t/something/something/{placeholder3}", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);
            _router.RegisterAction(new ControllerAction("/t/something/something/something", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => p);
        }
        ...
        {
            Assert.That(() => 
                _router.RegisterAction(new ControllerAction("/halt", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => new RequestParams(TimeSpan.Zero)),
        ...
        public void match_greedy_route_in_the_root_to_any_path()
        {
            ...
            tmpRouter.RegisterAction(new ControllerAction("/{*greedy}", HttpMethod.Get, Codec.NoCodecs, FakeController.SupportedCodecs, AuthorizationLevel.None), (x, y) => new RequestParams(TimeSpan.Zero));
