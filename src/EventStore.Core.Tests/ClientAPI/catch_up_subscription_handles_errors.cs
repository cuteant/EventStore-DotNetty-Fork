...
namespace EventStore.Core.Tests.ClientAPI
{
  ...
  public class catch_up_subscription_handles_errors
  {
    ...
    {
      return new VolatileEventStoreSubscription(new VolatileSubscriptionOperation(new TaskCompletionSource<EventStoreSubscription>(), StreamId, SubscriptionSettings.Default, null, raise, drop, () => null), StreamId, -1, lastEventNumber);
    }
  ...
  internal class FakeEventStoreConnection : IEventStoreConnection
  {
    ...
    public Task<EventStoreSubscription> SubscribeToStreamAsync(string stream, SubscriptionSettings settings, Func<EventStoreSubscription, ResolvedEvent, Task> eventAppeared, Action<EventStoreSubscription, SubscriptionDropReason, Exception> subscriptionDropped = null,
        UserCredentials userCredentials = null)
    {
