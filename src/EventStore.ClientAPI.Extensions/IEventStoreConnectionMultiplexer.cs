...
namespace EventStore.ClientAPI
{
  ...
  /// </summary>
  /// <remarks>
  /// An <see cref="IEventStoreConnectionMultiplexer"/> operates quite differently than say a SqlConnection. Normally
  ...
  /// </remarks>
  public interface IEventStoreConnectionMultiplexer : IDisposable
  {
    /// <summary>
    /// Connects the <see cref="IEventStoreConnectionMultiplexer"/> asynchronously to a destination
    /// </summary>
    /// <returns>A <see cref="Task"/> that can be waited upon.</returns>
    Task ConnectAsync();

    /// <summary>
    /// Closes this <see cref="IEventStoreConnectionMultiplexer"/>
    /// </summary>
    void Close();
    ...
    /// <summary>
    /// Sets the global settings for the server or cluster to which the <see cref="IEventStoreConnectionMultiplexer"/>
    /// is connected.
    /// </summary>
    ...
    /// <see cref="IEventStoreConnectionMultiplexer"/>.
    /// </summary>
