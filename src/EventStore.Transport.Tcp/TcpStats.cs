...
namespace EventStore.Transport.Tcp
{
    ...
    {
        /// <summary>Number of TCP connections to Event Store</summary>
        public readonly int Connections;

        /// <summary>Total bytes sent from TCP connections</summary>
        public readonly long SentBytesTotal;

        /// <summary>Total bytes received by TCP connections</summary>
