...
namespace EventStore.Transport.Tcp
{
    ...
    {
        private static readonly ILogger Log = TraceLogger.GetLogger("EventStore.Transport.Tcp.TcpTypedConnection");
        ...
        private void OnRawDataReceived(ITcpConnection connection, IEnumerable<ArraySegment<byte>> data)
        {
            ...
            {
                if (Log.IsInformationLevelEnabled()) Log.LogInformation(exc, "Invalid TCP frame received.");
