...
namespace EventStore.Transport.Tcp
{
    public sealed partial class DotNettyConnection : ITcpConnection, IEquatable<DotNettyConnection>
    {
        ...
        private readonly ConcurrentQueueWrapper<TcpPackage> _sendQueue = new ConcurrentQueueWrapper<TcpPackage>();
        ...
        sealed class ConcurrentQueueWrapper<T> : ConcurrentQueue<T>
        {
