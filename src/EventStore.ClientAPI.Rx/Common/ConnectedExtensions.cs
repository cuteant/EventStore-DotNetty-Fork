...
namespace EventStore.ClientAPI.Rx
{
  public static class ConnectedExtensions
  {
    ...
    {
      return source.IsConnected ? new Connected<TResult>(selector(source.Value)) : new Connected<TResult>();
    }

    public static IObservable<IConnected<TResult>> LaunchOrKill<TSource, TResult>(this IObservable<IConnected<TSource>> source,
    ...
    public static IObservable<IConnected<TResult>> LaunchOrKill<TSource, TSource2, TResult>(this IObservable<IConnected<TSource>> first,
