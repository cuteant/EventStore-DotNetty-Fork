...
namespace EventStore.Projections.Core.Services
{
    public class ProjectionStatistics
    {
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                int hashCode = (Status is object ? Status.GetHashCode() : 0);
                hashCode = (hashCode*397) ^ Enabled.GetHashCode();
                hashCode = (hashCode*397) ^ (int) MasterStatus;
                hashCode = (hashCode*397) ^ (StateReason is object ? StateReason.GetHashCode() : 0);
                hashCode = (hashCode*397) ^ (Name is object ? Name.GetHashCode() : 0);
                hashCode = (hashCode*397) ^ ProjectionId.GetHashCode();
                hashCode = (hashCode*397) ^ Epoch.GetHashCode();
                hashCode = (hashCode*397) ^ Version.GetHashCode();
                hashCode = (hashCode*397) ^ (int) Mode;
                hashCode = (hashCode*397) ^ (Position is object ? Position.GetHashCode() : 0);
                hashCode = (hashCode*397) ^ Progress.GetHashCode();
                hashCode = (hashCode*397) ^ (LastCheckpoint is object ? LastCheckpoint.GetHashCode() : 0);
                hashCode = (hashCode*397) ^ EventsProcessedAfterRestart;
                hashCode = (hashCode*397) ^ BufferedEvents;
                hashCode = (hashCode*397) ^ (CheckpointStatus is object ? CheckpointStatus.GetHashCode() : 0);
                ...
                hashCode = (hashCode*397) ^ (EffectiveName is object ? EffectiveName.GetHashCode() : 0);
                hashCode = (hashCode*397) ^ (ResultStreamName is object ? ResultStreamName.GetHashCode() : 0);
