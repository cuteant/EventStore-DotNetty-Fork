...
namespace EventStore.Common.Logging
{
  public class LazyLogger : ILogger
  {
    ...
    public bool IsTraceEnabled => _logger.Value.IsTraceEnabled;
    public bool IsDebugEnabled => _logger.Value.IsDebugEnabled;
    public bool IsInfoEnabled => _logger.Value.IsInfoEnabled;
    public bool IsWarnEnabled => _logger.Value.IsWarnEnabled;
    public bool IsErrorEnabled => _logger.Value.IsErrorEnabled;
    public bool IsFatalEnabled => _logger.Value.IsFatalEnabled;
