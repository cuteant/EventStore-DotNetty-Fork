...
namespace EventStore.ClientAPI.Exceptions
{
  ...
  public class UserCommandFailedException : EventStoreConnectionException
  {
    ...
    /// Constructs a new <see cref="UserCommandFailedException"/>.
    /// </summary>
    public UserCommandFailedException(string message, Exception innerException) : base(message, innerException)
    {
    }
    ...
    /// Constructs a new <see cref="UserCommandFailedException"/>.
    /// </summary>
    protected UserCommandFailedException(SerializationInfo info, StreamingContext context) : base(info, context)
    {
    }
  }
}