...
namespace EventStore.ClientAPI.Exceptions
{
  ...
  public class RetriesLimitReachedException : EventStoreConnectionException
  {
    ...
    /// <summary>
    /// Constructs a new <see cref="RetriesLimitReachedException"/>.
    /// </summary>
    protected RetriesLimitReachedException(SerializationInfo info, StreamingContext context) : base(info, context)
    {
    }
  }
}
