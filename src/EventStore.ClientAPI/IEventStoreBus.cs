...
namespace EventStore.ClientAPI
{
    public interface IEventStoreBus : IEventStoreConnectionBase
    {
        ...
        /// <returns></returns>
        EventData ToEventData(object evt, Dictionary<string, object> eventContext);

        /// <summary>TBD</summary>
        /// <param name="evt"></param>
        /// <param name="eventMeta"></param>
        /// <returns></returns>
        EventData ToEventData(object evt, IEventMetadata eventMeta = null);

        /// <summary>TBD</summary>
        /// <param name="events"></param>
        /// <param name="eventContexts"></param>
        /// <returns></returns>
        EventData[] ToEventDatas(IList<object> events, IList<Dictionary<string, object>> eventContexts);

        /// <summary>TBD</summary>
        /// <param name="events"></param>
        /// <param name="eventMetas"></param>
        /// <returns></returns>
        EventData[] ToEventDatas(IList<object> events, IList<IEventMetadata> eventMetas = null);
        ...
        /// <param name="eventContexts"></param>
        /// <returns></returns>
        EventData[] ToEventDatas<TEvent>(IList<TEvent> events, IList<Dictionary<string, object>> eventContexts);
