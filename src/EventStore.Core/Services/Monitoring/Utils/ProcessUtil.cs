...
namespace EventStore.Core
{
    ...
    static public class ProcessUtil
    {
        ...
        static private List<Process> WhoIsLocking(string path)
        {
            ...
            if (res != 0) ThrowHelper.ThrowException(ExceptionResource.Could_not_begin_restart_session);
            ...
            try
            {
                ...
                if (res != 0) ThrowHelper.ThrowException(ExceptionResource.Could_not_register_resource);
                ...
                if (res == ERROR_MORE_DATA)
                {
                    ...
                    else ThrowHelper.ThrowException(ExceptionResource.Could_not_list_processes_locking_resource);
                }
                else if (res != 0) ThrowHelper.ThrowException(ExceptionResource.Could_not_list_processes_locking_resource_F);
            }
            finally
            {
                RmEndSession(handle);
