...
namespace EventStore.ClientAPI
{
  ...
  {
    /// <summary>The ID of the event, used as part of the idempotent write check.</summary>
    public readonly Guid EventId;

    /// <summary>The name of the event type. It is strongly recommended that these
    /// use lowerCamelCase if projections are to be used.</summary>
    ...
    /// <summary>Constructs a new <see cref="EventData" />.</summary>
