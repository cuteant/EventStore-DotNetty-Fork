namespace EventStore.ClientAPI
{
  ...
  /// <see cref="T:EventStore.ClientAPI.IEventStoreConnection" />.</summary>
  public static class AllCheckpoint
  {
    /// <summary>Indicates that a catch-up subscription should receive all events in the database.</summary>
