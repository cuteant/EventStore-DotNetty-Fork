...
namespace EventStore.ClientAPI
{
    ...
    public class PersistentSubscriptionSettings
    {
                                                ...
                                                int maxSubscriberCount, string namedConsumerStrategy)
        {
            ...
            {
                ThrowHelper.ThrowArgumentException_MillisecondsMustBeLessOrEqualToThanInt32MaxValue(ExceptionArgument.messageTimeout);
            }
            if (checkPointAfter.TotalMilliseconds > Int32.MaxValue)
            {
                ThrowHelper.ThrowArgumentException_MillisecondsMustBeLessOrEqualToThanInt32MaxValue(ExceptionArgument.checkPointAfter);
            }
