namespace EventStore.ClientAPI
{
    ...
    {
        /// <summary>The write should not conflict with anything and should always succeed.</summary>
        public const long Any = -2L;

        /// <summary>The stream should not yet exist. If it does exist treat that as a concurrency problem.</summary>
        public const long NoStream = -1L;

        /// <summary>The stream should exist but be empty when writing. If it does not exist or is not empty treat that as a concurrency problem.</summary>
