...
namespace EventStore.ClientAPI
{
    ...
    public readonly struct Position
    {
        ...
        /// <summary>Constructs a position with the given commit and prepare positions.
        /// It is not guaranteed that the position is actually the start of a
        /// record in the transaction file.
        ///
        /// The commit position cannot be less than the prepare position.</summary>
        ...
        public Position(long commitPosition, long preparePosition)
        {
            ...
            {
                ThrowHelper.ThrowArgumentException_TheCommitPositionCannotBeLessThanThePreparePosition();
            }
        ...
        /// <summary>Compares this instance of <see cref="Position" /> for equality with another instance.</summary>
