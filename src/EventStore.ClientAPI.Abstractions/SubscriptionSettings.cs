...
namespace EventStore.ClientAPI
{
    ...
    public class SubscriptionSettings
    {
        ...
        public Int32 MaxMessagesPerTask
        {
            ...
            {
                Debug.Assert(this != Default, "Default instance is supposed to be immutable.");
                if (value < 1 && value != Unbounded) { ThrowHelper.ThrowArgumentOutOfRangeException(ExceptionArgument.value); }
        ...
        public virtual Int32 NumActionBlocks
        {
            ...
            {
                Debug.Assert(this != Default, "Default instance is supposed to be immutable.");
                if (value < 1) { ThrowHelper.ThrowArgumentOutOfRangeException(ExceptionArgument.value); }
