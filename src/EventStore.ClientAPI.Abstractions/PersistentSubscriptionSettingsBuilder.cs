...
{
    /// <summary>Builds a <see cref="PersistentSubscriptionSettings"/> object.</summary>
    public class PersistentSubscriptionSettingsBuilder
    {
        ...
        /// <summary>Sets the option to include further latency statistics. These statistics have a cost and should not be used
        /// in high performance situations.</summary>
        ...
        /// <summary>Sets the option to resolve linktos on events that are found for this subscription.</summary>
        /// <returns>A new <see cref="PersistentSubscriptionSettingsBuilder"></see></returns>
        ...
        /// <summary>Sets the option to not resolve linktos on events that are found for this subscription.</summary>
        /// <returns>A new <see cref="PersistentSubscriptionSettingsBuilder"></see></returns>
        ...
        /// <summary>If set the subscription will prefer if possible to round robin between the clients that are connected.</summary>
        /// <returns>A new <see cref="PersistentSubscriptionSettingsBuilder"></see></returns>
        ...
        /// <summary>If set the subscription will prefer if possible to dispatch only to a single of the connected clients.
        /// If however the buffer limits are reached on that client it will begin sending to other clients.
        /// </summary>
        /// <returns>A new <see cref="PersistentSubscriptionSettingsBuilder"></see></returns>
        ...
        /// <summary>Sets that the subscription should start from the beginning of the stream.</summary>
        /// <returns>A new <see cref="PersistentSubscriptionSettingsBuilder"></see></returns>
        ...
        /// <summary>Sets that the subscription should start from a specified location of the stream.</summary>
        /// <returns>A new <see cref="PersistentSubscriptionSettingsBuilder"></see></returns>
        ...
        /// <summary>Sets the timeout for a message (will be retried if an ack is not received within this timespan)</summary>
        /// <returns>A new <see cref="PersistentSubscriptionSettingsBuilder"></see></returns>
        ...
        /// <summary>Sets the timeout timespan to about 30k years. If you need larger please let us know.</summary>
        /// <returns>A new <see cref="PersistentSubscriptionSettingsBuilder"></see></returns>
        ...
        /// <summary>Sets that the backend should try to checkpoint the subscription after some
        /// period of time. Note that if the increment of the checkpoint would be below
        /// the minimum the stream will not be checkpointed at this time.</summary>
        /// <remarks>It is important to tweak checkpointing for high performance streams as they cause
        ...
        /// for instance are doing hundreds of messages/second through the subscription.</remarks>
        ...
        /// <summary>Sets the minimum checkpoint count. The subscription will not increment a checkpoint
        /// below this value eg if there is one item to checkpoint and it is set to five it will not checkpoint.</summary>
        /// <remarks>It is important to tweak checkpointing for high performance streams as they cause
        /// writes to happen back in the system. There is a trade off between the number of
        /// writes that can happen in varying failure scenarios and the frequency of
        /// writing out the checkpoints within the system. Normally settings such
        ...
        /// <summary>Sets the largest increment the subscription will checkpoint. If this value is
        ...
        /// <summary>Sets the number of times a message should be retried before being considered a bad message</summary>
        /// <returns>A new <see cref="PersistentSubscriptionSettingsBuilder"></see></returns>
        ...
        /// <summary>Sets the size of the live buffer for the subscription. This is the buffer used
        /// to cache messages while sending messages as they happen. The count is
        /// in terms of the number of messages to cache.</summary>
        /// <returns>A new <see cref="PersistentSubscriptionSettingsBuilder"></see></returns>
        ...
        /// <summary>Sets the size of the read batch used when paging in history for the subscription
        /// sizes should not be too big ...</summary>
        /// <returns>A new <see cref="PersistentSubscriptionSettingsBuilder"></see></returns>
        ...
        /// <summary>Sets that the subscription should start from where the stream is when the subscription is first connected.</summary>
        /// <returns>A new <see cref="PersistentSubscriptionSettingsBuilder"></see></returns>
        ...
        /// <summary>Sets the maximum number of subscribers allowed to connect.</summary>
        /// <returns>A new <see cref="PersistentSubscriptionSettingsBuilder"></see></returns>
        ...
        /// <summary>Sets the consumer strategy for distributing event to clients. See <see cref="SystemConsumerStrategies"/> for system supported strategies.</summary>
        /// <returns>A new <see cref="PersistentSubscriptionSettingsBuilder"></see></returns>
        public PersistentSubscriptionSettingsBuilder WithNamedConsumerStrategy(string namedConsumerStrategy)
        {
            if (string.IsNullOrEmpty(namedConsumerStrategy)) { ThrowHelper.ThrowArgumentNullException(ExceptionArgument.namedConsumerStrategy); }
            _namedConsumerStrategies = namedConsumerStrategy;
            return this;
        }

        /// <summary>Builds a <see cref="PersistentSubscriptionSettings"/> object from a <see cref="PersistentSubscriptionSettingsBuilder"/>.</summary>
