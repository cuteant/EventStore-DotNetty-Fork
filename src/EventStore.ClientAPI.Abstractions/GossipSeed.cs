...
{
    /// <summary>Represents a source of cluster gossip.</summary>
    public class GossipSeed
    {
        /// <summary>The <see cref="IPEndPoint"/> for the External HTTP endpoint of the gossip seed.
        ///
        ...
        /// used here is 2113.</summary>
        public readonly IPEndPoint EndPoint;

        /// <summary>If Gossip should be requested.</summary>
        public readonly bool SeedOverTls;

        /// <summary>The host header to be sent when requesting gossip.</summary>
        public readonly string HostHeader;

        /// <summary>Creates a new <see cref="GossipSeed" />.</summary>
