...
{
  /// <summary>Represents a way of discovering cluster endpoints. This could be through gossip, consul, text files, etc</summary>
  public interface IEndPointDiscoverer
  {
    /// <summary>Called to discover a new <see cref="IPEndPoint"/></summary>
